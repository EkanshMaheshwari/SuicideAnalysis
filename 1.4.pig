...
filterdatatypecode = filter data by typecode=='Means_adopted';
agetotal = foreach filterdatatypecode generate age,total; 
...
STORE orderoutputs INTO 'output/pig1.4 ' using org.apache.pig.piggybank.storage.CSVExcelStorage(',');
